...
curl -L --fail  --remote-name-all https://dumps.wikimedia.org/hiwiki/20231020/hiwiki-20231020-pages-meta-current.xml.bz2   --output hiwiki-pages-meta-current.xml.bz2
